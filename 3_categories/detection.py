...
#        FOR EACH ALGORITHM
algorithms = ['NN1', 'NN2']
indexes_selected = [[6545, 7347, 8019, 8387, 8466],
                    [7743, 7756, 7771, 7772, 7774]]
...
for liste, algorithm in zip(indexes_selected, algorithms):
    ...
    for index in liste:
        ...
        print('The probabilities found were:  QUASAR('+str(probas_original[0])
              + ')    -    GALAXY('+str(probas_original[1])
              + ')    -    STAR('+str(probas_original[2])+')')
